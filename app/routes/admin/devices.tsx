...
import { deviceStats } from "~/api/devices/read";
...
type DevicesSortbyStats = Prisma.PromiseReturnType<typeof deviceStats>;
...
export default function Devices() {
  ...
  let { devices } = useLoaderData<{ devices: DevicesSortbyStats }>();
  ...
  return (
    ...
    <Drawer>
      ...
      <div className="flex h-full w-full flex-col">
        ...
        {/* Main content section in the devices page */}
