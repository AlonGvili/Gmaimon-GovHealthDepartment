...
import { schoolStats } from "~/api/schools/read";
...
type SchoolsSortbyStats = Prisma.PromiseReturnType<typeof schoolStats>;
...
export default function Schools() {
  ...
  let { schools } = useLoaderData<{ schools: SchoolsSortbyStats }>();
  ...
  return (
    ...
    <Drawer>
      ...
      <div className="flex h-full w-full flex-col">
        ...
        {/* Main content section in the schools page */}
